...
Enemy::Enemy(int w, int h, double x, double y, double speed, double angle, double canSpilt, double hp, const string& image_path)
: w(w), h(h), x(x), y(y), speed(speed), angle(angle), health_point(hp), canSpilt(canSpilt) {
